...
window.onload = async () => {
    ...
    try {
        // 在线效果查看地址: https://vjmap.com/demo/#/demo/map/service/05openMapFromLocal
        // --通过服务器本地路径打开地图--传入服务器本地DWG路径打开DWG图
        // 把div背景改成浅色
        ...
        let res = await svc.openMap({
            mapid: "hello", // 地图ID (每一次打开此地图ID时，会根据fileid去获取dwg路径打开，之后会读取缓存打开)
            fileid: "mapfiles/cfae42554bbe.dwg", // 必须是相对路径，路径相于服务器程序安装目录data下面
