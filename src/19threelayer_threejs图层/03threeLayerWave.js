...
window.onload = async () => {
    ...
    try {
        // 在线效果查看地址: https://vjmap.com/demo/#/demo/map/threelayer/03threeLayerWave
        // --波动光圈--
        ...
        const addWaves = () => {
            ...
            for (let i = 0; i < 100; i++) {
                ...
                let coneMesh = threeContext.wave(pt, {
                    ...
                    <div className="input-card">
                        ...
                        <div>
                            <div className="input-item">
                                <button className="btn" onClick={() => removeWaves()}>移除</button>
                                <button className="btn" onClick={() => addWaves()}>添加</button>
                            </div>
                        </div>
                    </div>
                </div>
