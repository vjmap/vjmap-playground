...
window.onload = async () => {
    ...
    try {
        // 在线效果查看地址: https://vjmap.com/demo/#/demo/map/threelayer/threeLayerPoints
        // --threejs多个球体--
        // 地图服务对象
        ...
        const sphereTemplate = threeContext.sphere(
            {
                radius: 10000,
                sides: 120,
                color: 'purple',
        ...
        // 为了获得最佳性能，请为 randomPoint 中的每个点克隆模板球体
        randomPoints.forEach(function (pt) {
            let newSphere = sphereTemplate
                .duplicate()
                .setCoords(pt);
        
            threeContext.add(newSphere);
        })
