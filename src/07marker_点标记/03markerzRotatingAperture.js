...
window.onload = async () => {
    ...
    try {
        // 在线效果查看地址: https://vjmap.com/demo/#/demo/map/marker/03markerzRotatingAperture
        // --旋转的光环--
        // 地图服务对象
        ...
        // 创建一个缺省的
        let markerEle = new vjmap.RotatingApertureMarker({
        ...
        for(let i = 1; i < 20; i++) {
            // 再随机生成不同样式的
            let _marker = new vjmap.RotatingApertureMarker({
                lngLat: map.toLngLat(mapBounds.randomPoint()),
                text: "文字" + i
            }, {
                // 可以给不同的属性，如宽度，颜色，字体
