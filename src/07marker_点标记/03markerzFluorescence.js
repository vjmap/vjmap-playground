...
window.onload = async () => {
    ...
    try {
        // 在线效果查看地址: https://vjmap.com/demo/#/demo/map/marker/03markerzFluorescence
        // --荧光点--
        // 地图服务对象
        ...
        // 创建一个缺省的
        let markerEle = new vjmap.FluorescenceMarker({
        ...
        for(let i = 1; i < 20; i++) {
            // 再随机生成不同样式的
            let _marker = new vjmap.FluorescenceMarker({
                lngLat: map.toLngLat(mapBounds.randomPoint()),
                text: "文字" + i
            }, {
                // 可以给不同的属性，如宽度，颜色，字体
                //width: vjmap.randInt(20, 30),
